...
#### 读取裁剪出的小猪猪的均值和方差
img = cv2.imread(r'C:\Users\PC\Desktop\pigonly\1-22.png', 1)                 # 1是以彩色图方式去读
...
with open(r'D:\Zhenong\data\train.csv', 'a', newline='') as f:
    csv_writer = csv.writer(f)
    # csv_writer.writerow([r1, r2, r3, 0])
    ...
    for i in range(img.shape[0]):  # 读取前三个通道的像素值
        for j in range(img.shape[1]):
            ...
            if sum(lst) != 0:
                ...
                r2.append(lst[1])
                r3.append(lst[2])
                csv_writer.writerow([lst[0], lst[1], lst[2], 1])
...
# with open(r'D:\Zhenong\data\all_test.csv', 'a', newline='') as f:
#     csv_writer = csv.writer(f)
#     csv_writer.writerow([r1, r2, r3, 0])
